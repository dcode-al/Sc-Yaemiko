...
let handler = async (m, { conn, text, command }) => {
  ...
  {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"Lanjut Mencari","id": ".tiktoksearch ${text}"}`
  },
  {
"name": "quick_reply",
  "buttonParamsJson": `{"display_text":"Yt search","id": ".yts ${text}"}`
  },
  {
name: "cta_copy",
                buttonParamsJson: `{\"display_text\":\"Copy Judul\",\"id\":\"123456789\",\"copy_code\":\"${kemii.title}\"}`
  }
  ],
  })
  })
