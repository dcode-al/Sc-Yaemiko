...
let handler = async (m, { conn, args }) => {
  try {
    ...
    try {
      ...
      ttsResponse = await axios.get(`https://apisku-furina.vercel.app/api/tts?apikey=indradev&text=${encodeURIComponent(aiText)}&character=nami`);
