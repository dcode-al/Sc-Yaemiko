...
const Bexp = 550
const Baqua = 5000
const Bcocacola = 7500
const Saqua = 1000
const Scocacola = 3000
const Biron = 20000
const Siron = 5000
const Bstring = 50000
const Sstring = 5000
...
============================
🛍️ *Kebutuhan   |  Harga Beli*
💫Limit:     ${Blimit}
TiketM:     ${Bhealtmonster}
Cupon:     ${Btiketcoin}
KoinExpg:     ${Bkoinexpg}

🛍️*Kebutuhan   |  Harga Jual*
💫Limit:     ${Slimit}
============================
                ...
                case 'makanankyubi':
                 ...
                 case 'makanangriffin':
                  ...
                  case 'aqua':
                        ...
                        break
                        case 'cocacola':
                            if (global.db.data.users[m.sender].money >= Bcocacola * count) {
                                global.db.data.users[m.sender].cocacola += count * 1
                                global.db.data.users[m.sender].money -= Bcocacola * count
                                conn.reply(m.chat, `Succes membeli ${count} Cocacola dengan harga ${Bcocacola * count} money`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} cocacola dengan harga ${Bcocacola * count} money`.trim(), m)
                ...
                switch (_type) {
                   ...
                   case 'emas':
                    ...
                    case 'aqua':
                        ...
                        break
                        case 'cocacola':
                        if (global.db.data.users[m.sender].cocacola >= count * 1) {
                            global.db.data.users[m.sender].cocacola -= count * 1
                            global.db.data.users[m.sender].money += Scocacola * count
                            conn.reply(m.chat, `Succes menjual ${count} cocacola, dan anda mendapatkan ${Scocacola * count} money`, m)
                        } else conn.reply(m.chat, `Cocacola anda tidak cukup`, m)
                        break
                    case 'pancingan':
