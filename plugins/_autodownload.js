...
async function _tiktok(link, m) {
	try {
		if (global.db.data.users[m
			...
			const response =
				await fetch(
					`https://api.botcahx.eu.org/api/download/tiktok?url=${link}&apikey=tnUW4mZs`
				);
			const data =
				await response
				.json();
...
async function _douyin(link, m) {
	try {
		if (global.db.data.users[m
			...
			let response =
				await fetch(
					`https://api.botcahx.eu.org/api/download/douyin?url=${link}&apikey=tnUW4mZs`
				);
			let data =
				await response
				.json();
			if (!data.result
				...
				response =
					await fetch(
						`https://api.botcahx.eu.org/api/download/douyinslide?url=${link}&apikey=tnUW4mZs`
					);
				data =
					await response
					.json();
...
async function _instagram(link, m) {
	try {
		if (global.db.data.users[m
			...
			const response =
				await fetch(
					`https://api.botcahx.eu.org/api/dowloader/igdowloader?url=${link}&apikey=tnUW4mZs`
				);
			const res =
				await response
				.json();
...
async function _facebook(link, m) {
	try {
		if (global.db.data.users[m
			...
			const response =
				await fetch(
					`https://api.botcahx.eu.org/api/dowloader/fbdown3?url=${link}&apikey=tnUW4mZs`
				);
			let json =
				await response
				.json();
...
async function _youtube(link, m) {
	try {
		if (global.db.data.users[m
			...
			const response =
				await fetch(
					`https://api.botcahx.eu.org/api/dowloader/yt?url=${link}&apikey=tnUW4mZs`
				);
			const result =
				await response
				.json();
	...
	try {
		if (global.db.data.users[m
			...
			const res = await fetch(
				`https://api.botcahx.eu.org/api/download/spotify?url=${url}&apikey=tnUW4mZs`
			);
	...
	try {
		if (global.db.data.users[m
			...
			const api = await fetch(
				`https://api.botcahx.eu.org/api/download/twitter2?url=${url}&apikey=tnUW4mZs`
			);
			const res = await api
				.json();
			if (res.result && res
...
async function _threads(url, m) {
	try {
		if (global.db.data.users[m
			...
			const apiResponse =
				await fetch(
					`https://api.botcahx.eu.org/api/download/threads?url=${url}&apikey=tnUW4mZs`
				);
			const api =
				await apiResponse
				.json();
...
async function _capcut(url, m) {
	try {
		if (global.db.data.users[m
			...
			const response =
				await fetch(
					`https://api.botcahx.eu.org/api/dowloader/capcut?url=${url}&apikey=tnUW4mZs`
				);
			const res =
				await response
				.json();
...
async function _snackvideo(url, m) {
	try {
		if (global.db.data.users[m
			...
			0) {
			const api = await fetch(
				`https://api.botcahx.eu.org/api/download/snackvideo?url=${url}&apikey=tnUW4mZs`
			);
			const res = await api
				.json();
			const {
