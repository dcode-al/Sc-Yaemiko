...
"Dear kamu yang tertulis di halaman defacementku, Kapan jadi pacarku?",
  ...
  let hackerText = pickRandom(global.hacker);
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              newsletterName: 'Powered By Furina',
              serverMessageId: -1
            },
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
              {
                "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"Lanjut","id": ".motivasi"}`
              }
            ]
          })
        })
...
handler.command = /^(hacker|haker)$/i;
handler.tags = ['info'];
handler.help = ['hacker'];
