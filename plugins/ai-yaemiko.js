 ...
 */
        const messages = [
            { role: "system", content: "kamu adalah Yaemiko, Seorang Asisten pribadi yang di buat oleh Al Dev yang siap membantu kapan pun!" },
            { role: "assistant", content: `Saya Yaemiko, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
...
handler.command = ['yaemikoai'];
handler.tags = ['ai'];
handler.help = ['yaemikoai'].map(a => a + ' *enable/disable*');
handler.limit = true
