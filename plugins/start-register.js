...
const handler = async (m, {
    ...
    let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://pomf2.lain.la/f/httylezy.jpg");
...
async function createOtpCanvas(avatar) {
    ...
    const captchaBuffer = await new canvafy.Captcha()
        .setBackground("image", "https://pomf2.lain.la/f/kpbgxd5e.jpg")
