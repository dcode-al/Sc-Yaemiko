let handler = async (m, { conn, command, args }) => {
    ...
    try {
        if (command === 'live') {
            ...
            // Periksa apakah judul disediakan dan tidak melebihi 50 karakter
            let title = args.join(' ');
            ...
            // Simulasikan live streaming dengan memberikan statistik acak
            ...
            // Periksa hadiah Play Button berdasarkan milestone subscribers
            ...
            // Kirim pesan live streaming dengan statistik
